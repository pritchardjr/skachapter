...
\begin{table*}[htdp]
\caption{Fiducial parameter values and $1-\sigma$ experimental uncertainties for cosmological parameters. Here we restrict to cosmological parameters, and do not show other parameters \{$\tau$, $x_H(z=7)$, $x_H(z=7.5)$, $x_H(z=8)$\} included in the analysis. }
\begin{center}
